                ...
                <Dialog.Content className='fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] h-[60vh] w-full bg-slate-700 rounded-md flex flex-col outline-none'>
                  ...
                  <div className='flex flex-1 flex-col gap-3 p-5'>
                    ...
                    </span>
                    {
                     ...
                     Comece <button className='font-medium text-lime-400 hover:underline'>gravan do uma nota</button> em áudio ou se preferir <button className='font-medium text-lime-400 hover:underline' 
                  ...
                  <button
                    type='submit'
                    className={`w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500 ${!content ? 'opacity-80 cursor-not-allowed hover:bg-lime-400': ''}`}
                    disabled={!content}
                  >
                    Salvar notas
                  </button>
